...
public class ScheduleAssignmentRecord implements Serializable {
	...
	public String toString() {
		return "\n ScheduleAssignmentRecord = [recordID=" + recordID + ", mbu=" + mbu + ", lob=" + lob + ", effectiveDate="
				+ effectiveDate + ",\n state=" + state + ", contractCode=" + contractCode + ", exchangeIndicator="
				+ exchangeIndicator + ", useInd=" + useInd + ", parTIN=" + parTIN + ", weightage=" + weightage
				+ ", result=" + result + "]";
	}	
